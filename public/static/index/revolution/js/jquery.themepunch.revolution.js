		...
		function prepareOneSlideV(slotholder,opt,visible) {
				...
				for (var i=0;i<opt.slots+2;i++)
					sh.append('<div class="slot" style="position:absolute;'+
												 ...
												 'left:0px;width:'+w+'px;'+
												 'height:'+opt.sloth+'px;'+
												 'overflow:hidden;"><img style="position:absolute;'+              'background-color:'+bgcolor+';'+              'top:'+(0-(i*opt.sloth))+'px;'+              'left:0px;width:'+w+'px;'+              'height:'+h+'px" src="'+src+'"></div></div>');
				...
				for (var j=0;j<opt.slots;j++) {
					...
					for (var i=0;i<opt.slots;i++) 	{
						...
						sh.append('<div class="slot" '+
								  ...
								  '<img style="position:absolute;'+            'top:'+(0-y)+'px;'+            'left:'+(0-x)+'px;'+            'width:'+w+'px;'+            'height:'+h+'px'+            'background-color:'+bgcolor+';"'+           'src="'+src+'"></div></div>');
						y=y+basicsize;
					}
					x=x+basicsize;
				}
